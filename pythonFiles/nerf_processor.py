...
def quaternion_to_rotation_matrix(qx, qy, qz, qw):
    ...
    # Based on standard quaternion to matrix conversion
...
def process_orbit_session(session_dir):
    ...
    transforms = {
        "camera_angle_x": 1.2, # Tahmini fov (veya kameradan hesaplanabilir)
        "frames": []
    }
    ...
    with open(csv_path, mode='r', encoding='utf-8') as f:
        ...
        for row in reader:
            ...
            frame_data = {
                "file_path": cam1_img, # Örneğin "cam1/frame_0_...jpg"
    ...
    # Opsiyonel - Nerfstudio splatfacto otomatik tetikleme
    # Eğer komut başarısız olursa exception fırlatmaması için try/except kullanıyoruz
    try:
        print("  [+] Splatfacto eğitimi başlatılıyor...")
        # NOT: Aslında bunu subprocess.Popen ile açabiliriz. Popen kullanmak terminali bloklamaz.
        # Bu sadece arka planda çalışmasını sağlar. Gelişmiş kullanım için viser arayüzünü tarayıcıda otomatik açar.
